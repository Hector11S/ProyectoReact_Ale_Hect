...
namespace SIMEXPRO.BussinessLogic.Services.ProduccionServices
{
    public class ProduccionServices
    {
        ...
        public ServiceResult EliminarTalla(tbTallas item)
        {
            var result = new ServiceResult();
            try
            {
        ...
        public ServiceResult ListarSubCategoriasByIdtalla(int tall_Id)
        {
            var result = new ServiceResult();
            try
            {
                var list = _tallasRepository.ListByIdtalla(tall_Id);
                return result.Ok(list);
            }
            catch (Exception ex)
            {
